...
truncate=solamente.truncate(before='Name', after='Type', axis=1)
truncate.to_csv('truncate.csv')

#merge Dataframes based on KRas mutants
#match_column=truncate.merge(truncate, gene_dependency, how='left', left_on=None, right_on=None)
